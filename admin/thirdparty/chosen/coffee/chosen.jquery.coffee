...
class Chosen extends AbstractChosen
  ...
  set_up_html: ->
    ...
    ### SILVERSTRIPE: add style="left:-9000px;" back in ###
    if @is_multiple
      ...
      @container.html '<a class="chzn-single chzn-default" tabindex="-1"><span>' + @default_text + '</span><div><b></b></div></a><div class="chzn-drop" style="left:-9000px;"><div class="chzn-search"><input type="text" autocomplete="off" /></div><ul class="chzn-results"></ul></div>'
  ...
  results_hide: ->
    if @results_showing
      ...
      ###
      SILVERSTRIPE - Our css integrations rely on this, but chosen has since replaced it.
      Test and remove if things work on upgrade.
      ###
